...
The overall workflow follows the sequence: video preprocessing and image data extraction → building semantic segmentation datasets → UNet model training to obtain masks → data pipeline operations.
